$(window).bind("load", function() {
    ...
    async function refresh () {
        try
        {
            ...
            $("#athon_price").text(marketvalues.ATHON.lastPrice);
            $("#athon_value").text((marketvalues.ATHON.lastPrice * marketvalues.HIVE).toFixed(8));
            $("#athon_vol").text((marketvalues.ATHON.volume * marketvalues.HIVE).toFixed(8));
            $("#athon_change").text(marketvalues.ATHON.priceChangePercent);
        }
        catch (error)
        {
